...
<head>
    ...
    <script type="text/javascript">
        //全局变量
        var keyword = '${searchTerm.keywords}';
        var brandId = '${searchTerm.brand}';
        var price = '${searchTerm.price}';
        //过滤条件
        //品牌过滤  id == 品牌ID
        function fqBrand(id) {
            if (price != '') {
                //刷新
                window.location.href = "/search?keywords=" + keyword + "&brandId=" + id + "&price=" + price;
            } else {
                //刷新
                window.location.href = "/search?keywords=" + keyword + "&brandId=" + id;
            }
        }
        ...
        function fqPrice(id) {
            if (brandId != '') {
                //刷新
                window.location.href = "/search?keywords=" + keyword + "&price=" + id + "&brandId=" + brandId;
            } else {
                //刷新
                window.location.href = "/search?keywords=" + keyword + "&price=" + id;
            }
        }
    </script>
                ...
                <c:if test="${fn:length(map) != 0 }">
                    <div class="sl-b-selected J_brandSelected">
                        ...
                        <c:forEach items="${map }" var="m">
                            <a title="品牌：依琦莲（yiqilian）" onclick="alert(1)" href="javascript:;"
                    ...
                    <div class="sl-value">
                        <div class="sl-v-list">
                            <ul class="J_valueList v-fixed">
                                <c:forEach items="${searchResultSet.brands}" var="brand">
                                    <li id="brand-38118" data-initial="j" style="display:block;">
                                        <a href="javascript:;" onclick="fqBrand('${brand.name}')" title="${brand.name}"><i></i>${brand.name}
                                        </a>
                                    </li>
                                </c:forEach>
                            </ul>
                    ...
                    <div class="sl-value">
                        <div class="sl-v-list">
                            <ul class="J_valueList">
                                ...
                                <c:forEach items="${searchResultSet.features}" var="feature">
                                    <li>
                                        <a href="javascript:;"><i></i>${feature.name}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
                ...
                <div class="J_selectorLine s-line">
                    <div class="sl-wrap">
                        ...
                        <div class="sl-value">
                            <div class="sl-v-list">
                                <ul class="J_valueList">
                                    <c:forEach items="${searchResultSet.types}" var="type">
                                        <li>
                                            <a href="javascript:;"><i></i>${type.name}</a>
                                        </li>
                                    </c:forEach>
                                </ul>
                            </div>
                        ...
                        <div class="ml-wrap">
                            <div id="J_filter" class="filter">
                                <div class="f-line top">
                                    ...
                                    <div class="f-result-sum">共<span id="J_resCount" class="num">${searchResultSet.total}</span>件商品</div>
                                    <span class="clr"></span>
                                </div>
                                <div class="f-line">
                                    <div class="f-store">
                            ...
                            <div id="J_goodsList" class="goods-list-v1 gl-type-1 J-goods-list">
                                <ul class="gl-warp clearfix" data-tpl="1">
                                    <c:forEach items="${searchResultSet.rows}" var="product">
                                        <li data-sku="1711416562" class="gl-item">
                                            <div class="gl-i-wrap">
                                                <div class="p-img">
                                                    <a href="javascript:;"
                                                       onclick="window.open('http://localhost:8888/html/product/${product.id}.html')"
                            ...
                            <div class="page pb15">
                                <div class="r inb_a page_b" style="float: right;">
                                    <%--<c:forEach items="${searchResultSet.totalPages}" var="page">--%>
                                        <%--${page}--%>
                                    <%--</c:forEach>--%>
                                </div>
                            </div>
