    ...
    a.fn.jdMarquee = function(b, c) {
        ...
        var k = function() {
            ...
            null != e._front && a(e._front).click(function() {
                a(e._front).addClass(e.disabled), o(!0), n(e.mainTimer), e.convert = !0, e.btn = "login", m(), e.auto || (e.tag = !0), q()
            ...
            e.tag && e.convert && (e.convert = !1, "login" == e.btn && ("down" == e.deriction && (e.deriction = "up"), "right" == e.deriction && (e.deriction = "left")), "back" == e.btn && ("up" == e.deriction && (e.deriction = "down"), "left" == e.deriction && (e.deriction = "right")), e.auto ? l() : l(4 * e.delay))
        }, r = function(a, b, c) {
