...
// ##### Defining a custom page menu entry.

// ## 1. Define the command to be executed when selecting the page menu item.
var oMyCMCommand = new Object() ;
oMyCMCommand.Name = 'OpenImage' ;

// This is the standard function used to execute the command (called when clicking in the page menu item).
...
// ## 3. Define the page menu "listener".
var oMyContextMenuListener = new Object() ;

// This is the standard function called right before sowing the page menu.
...
// ## 4. Register our page menu listener.
