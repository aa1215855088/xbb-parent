...
<c:if test="${fn:length(cartList.items) != 0}">
    <div class="w cart">
        <div class="cart-hd group">
            <h2>我的购物车</h2>
        </div>
        <form id="jvForm" action="http://localhost:8881/order/getOrderInfo" method="post">
            <div id="show">
                ...
                <div class="cart-inner">
                                ...
                                <div class="item_form clearfix">
                                        ...
                                        <div class="p-img">
                                            <a href="javascript:;" target="_blank">
                                                <img
                                                        ...
                                                        alt="${item.cartDTO.name}" width="52" height="52"></a>
                                        </div>
                                        <div class="p-name">
                                            <a href="http://localhost:8888/html/product/${item.cartDTO.id}.html"> ${item.cartDTO.name}--
                                                    ${item.cartDTO.color}-- ${item.cartDTO.size } </a>
                                        </div>
                                    </div>
                                    <div class="cell p-price">
                                        <span class="price"> ¥${item.cartDTO.price} </span>
                                    </div>
                                    ...
                                    <div class="cell p-quantity" for-stock="for-stock-11345721">
                                        <div class="quantity-form">
                                            ...
                                            <input value="${item.amount}" type="text" name="amount" class="quantity-text">
                                            <a href="javascript:void(0);" class="increment">+</a>
                                        </div>
                                    </div>
                                    <div class="cell p-remove">
                                        <a class="cart-remove" onclick="delCart(${item.cartDTO.id})"
                    ...
                    <div class="cart-toolbar clearfix">
                        <div class="total fr">
                            <p>
                                <span class="totalSkuPrice">¥${cartList.productPrice }</span>商品金额：
                            </p>
                            <p>
                                <span id="totalRePrice"> ¥${cartList.fee }</span>运费：
                            </p>
                        </div>
                        <div class="amout fr">
                            <span id="selectedCount">${cartList.productAmount }</span> 件商品
                        </div>
                    </div>
                        ...
                        <div class="cart-dibu ui-ceilinglamp-current"
						 ...
						 <span class="delete"> 
                            ...
                            <div class="cart-total-2014">
                                ...
                                <div class="total fr">
                                    总计： <span class="totalSkuPrice">¥${cartList.totalPrice }</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="cart-empty">
                <div class="message">
                    <ul>
                        ...
                        <li>
                            <a class="btn-1 login-btn mr10" href="#" onclick="login()">登录</a>
                            <a class="ftx-05" href="http://localhost:8087/home">去购物&gt;</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<script>
    function delCart(id) {
        window.location = "${pageContext.request.contextPath}/delCart/"+id
    }
